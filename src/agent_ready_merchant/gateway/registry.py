...
class CapabilityRegistry:
    ...
    _CAPABILITIES: dict[str, CapabilityDefinition] = {
        ...
        "list_approvals": CapabilityDefinition(
            name="list_approvals",
            description="List pending or historical Human-In-The-Loop merchant approval tickets.",
            input_schema_name="ListApprovalsRequest",
            output_schema_name="ListApprovalsResponse",
